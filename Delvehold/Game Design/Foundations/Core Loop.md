...
The first playable world contains one Vault and its Hold, one active workshop site, one baseline institution, one dungeon core, one contract type, one expedition party, one extracted material, and one persistent expedition history.
