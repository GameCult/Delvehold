...
## Hold-local markets and supply chains

Each Hold is a local market and service ecology. Availability and prices emerge from its inventories, active workshop sites, institutional budgets and mandates, production capacity, population demand, expedition returns, and the time, capacity, cost, and risk of connected routes. A workshop may inspect its remote sites, but there is no global inventory, universal listing, or instant internal transfer.
...
**Workshop contracts** are authored by HOLD players. Their targets, issuing site and Hold, supplied equipment, compensation, acceptable substitutions, and desired returns express a particular workshop's needs and judgement.
