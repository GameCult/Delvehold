---
title: World state model
description: The canonical subjects, components, events, and derived projections of DELVE/HOLD.
---

DELVE/HOLD canonical state is typed CultCache state published through CultMesh. Components are sparse and owned: an expedition has participants and a contract; a workshop identity has one seal while its sites have facilities; a resource has custody and provenance. There is no universal property bag or client-owned mirror promoted to truth.

## Greathold state families
...
A workshop identity owns one seal, its practice, portable knowledge, history, and relationships. Its singular civic home owns ordinary local franchise and social affiliation. Its zero-to-many workshop sites own Hold-local facilities, installed methods, inventories and custody, staff, listings, orders, reservations, production history, and institutional access. One versioned 36-hour presence lease covers the identity and every site. Dormancy checkpoints them through one receipted transition; later activation wakes the same identity and eligible sites without cloning or relocating local state.
